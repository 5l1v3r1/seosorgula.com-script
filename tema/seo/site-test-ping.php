<div class="row sorgulama">
	<div class="col-md-2"></div>
				<div class="col-md-8 text-center">
					<div class="row ">
						<h1><strong>Site Test Ping</strong></h1>
						<p class="col-md-offset-2 col-md-8">Site Test Ping Sistemi</p>
						<div class="row">
...
<div class="sonuclar container">
	<h4>Site Test Ping</h4>
	<div class="row box-header">
	<h3><?php echo ucwords(strtolower(p("site"))); ?> - Online</h3>
	</div>
<?php
		$kaynak = file_get_contents("http://api.hackertarget.com/nping/?q=".p("site"));
