<div class="row sorgulama">
	<div class="col-md-2"></div>
				<div class="col-md-8 text-center">
					<div class="row ">
						<h1><strong>DNS Lookup Bilgisi</strong></h1>
						<p class="col-md-offset-2 col-md-8">DNS Lookup Bilgi Sistemi</p>
						<div class="row">
...
<div class="sonuclar container">
	<h4>DNS Lookup Bilgisi</h4>
	<div class="row box-header">
	<h3><?php echo ucwords(strtolower(p("site"))); ?> - Online</h3>
	</div>
<?php
		$kaynak = file_get_contents("http://api.hackertarget.com/dnslookup/?q=".p("site"));
