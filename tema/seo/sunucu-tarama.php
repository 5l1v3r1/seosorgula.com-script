<div class="row sorgulama">
	<div class="col-md-2"></div>
				<div class="col-md-8 text-center">
					<div class="row ">
						<h1><strong>Sunucu Tarama</strong></h1>
						<p class="col-md-offset-2 col-md-8">Sunucu Tarama Sistemi</p>
						<div class="row">
									...
									<form method="POST">
										<div class="input-group input-group-lg">
											...
											<span class="input-group-btn">
												<input type="submit" class="btn btn-primary" name="sorgula" value="Sunucu Tara" title="Sunucu Tara">
											</span>
										</div>
									</form> 
								</div>
...
<?php
		$kaynak = file_get_contents("http://api.hackertarget.com/reverseiplookup/?q=".p("site"));
		echo '<pre><strong>Sunucuda Bulunan Diğer Siteler</strong>: <br/><br/>'.htmlspecialchars($kaynak).'</pre>';
		?>
<?php  } } ?>
</div>